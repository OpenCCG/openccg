	...
	public static class Factory implements WordFactory {
		...
		private Word getOrCreateFromW() {
			...
			if (w.isSurfaceWord() && w.attrValPairs == null) {
				...
				retval = new FullWord(w.form, w.pitchAccent, w.attrValPairs, w.stem, w.POS,
						w.supertag, w.semClass);
		...
		/**
		 * Creates a (surface or full) word with the given normalized attribute
		 * name and value. The attribute names Tokenizer.WORD_ATTR, ...,
