...
/**
 * The Tokenizer interface provides a way to customize tokenization and handling
 * of special tokens. A custom tokenizer may be specified in the grammar file.
 * DefaultTokenizer provides a default implementation, which can also be
...
public interface Tokenizer {
	...
	/** Name used to tokenize caps associate. */
	public static final String CAPS_ASSOCIATE = "c";

	/** Name used to tokenize stem associate. */
	public static final String TERM_ASSOCIATE = "S";

	/** Name used to tokenize part-of-speech associate. */
	public static final String FUNCTIONS_ASSOCIATE = "P";

	/** Name used to tokenize supertag associate. */
	public static final String SUPERTAG_ASSOCIATE = "T";

	/** Name used to tokenize discourse entity class associate. */
	...
	/**
	 * Constant used to signal the substitution of a named entity (not listed in
	 * lexicon) as the pred.
	 */
